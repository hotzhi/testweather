package com.hotzhi.testweather.model;
...
import com.hotzhi.testweather.db.TestWeatherOpenHelper;
...
public class TestWeatherDB {
    ...
    private TestWeatherDB(Context context) {
        TestWeatherOpenHelper dbHelper = new TestWeatherOpenHelper(context, DB_NAME, null, VERSION);
